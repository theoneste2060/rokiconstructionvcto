        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-5 flex gap-3">
              {/* Social icons */}
              <a href="#" className="p-2 rounded-lg bg-gray-800/50 hover:bg-primary/20 hover:text-primary-light transition-all duration-200" aria-label="Facebook">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
              </a>
              <a href="#" className="p-2 rounded-lg bg-gray-800/50 hover:bg-primary/20 hover:text-primary-light transition-all duration-200" aria-label="Twitter">
              ...
              <a href="#" className="p-2 rounded-lg bg-gray-800/50 hover:bg-primary/20 hover:text-primary-light transition-all duration-200" aria-label="LinkedIn">
              ...
              <a href="#" className="p-2 rounded-lg bg-gray-800/50 hover:bg-primary/20 hover:text-primary-light transition-all duration-200" aria-label="Instagram">
      ...
      <div className="border-t border-gray-800/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} ROKI Construction Rwanda. All rights reserved.
          </p>
